...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="bg-soft-cream py-8 border-y border-soft-gold/15">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-soft-gold/20 font-sans">
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-4 md:py-0">
            ...
            <p className="text-xs text-dark-gray/80 max-w-[200px]">Tailor ribbon shapes, wrapping paper, and custom notes.</p>
          </div>
          <div className="flex flex-col items-center justify-center gap-2 py-4 md:py-0">
      ...
      <section className="py-24 bg-warm-ivory bg-artisan-grid border-b border-soft-gold/10" id="categories">
      ...
      <section className="py-24 bg-soft-cream/60 border-b border-soft-gold/10 relative overflow-hidden" id="our-story">
      ...
      <section className="py-24 bg-warm-ivory bg-artisan-grid border-b border-soft-gold/10" id="featured-products">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          {/* Header */}
